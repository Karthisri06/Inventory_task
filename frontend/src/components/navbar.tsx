...
//   return (
//     <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-4 justify-content-end">
//       {/* <div className="navbar-brand">Online Bookstore Admin</div> */}
...
//   let user: User = { name: 'Guest', role: 'Viewer' };
