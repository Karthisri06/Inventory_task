...
//     { title: "Low Stock Alert", count: 8, variant: "warning" },
//     { title: "Customers", count: 56, variant: "success" },
//   ];
...
//         const lowStockProducts = response.data.filter((product: { quantity: number; }) => product.quantity < 10);
